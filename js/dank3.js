...
(function () {
  ...
  window.tram = (function (a) {
          ...
          if (a) {
            ...
            if ("object" == e) {
              ...
              u.call(
                ...
                t.call(this),
                f > 0 && ((this.timer = new S({ duration: f, context: this })), (this.active = !0), b && (this.timer.complete = h));
              var g = this,
                j = !1,
                k = {};
              J(function () {
        ...
        (a.init = function (a, b, d, e) {
          ...
          (a.fallback = function (a) {
            ...
            (a = this.convert(a, this.type)),
              ...
              (this.tween = new R({ from: c, to: a, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this }));
          }),
          (a.get = function () {
      ...
      Q = l(N, function (a, b) {
        ...
        (a.init = function () {
          b.init.apply(this, arguments),
            this.current ||
              ((this.current = {}), Z.perspective && U.perspective && ((this.current.perspective = U.perspective), V(this.el, this.name, this.style(this.current)), this.redraw()));
        }),
          (a.set = function (a) {
    ...
    G.transform &&
      ((Y.transform = [Q]),
      (Z = { x: [w, "translateX"], y: [w, "translateY"], rotate: [x], rotateX: [x], rotateY: [x], scale: [t], scaleX: [t], scaleY: [t], skew: [x], skewX: [x], skewY: [x] })),
  ...
  var topOffset = $(".navbar.w-nav").height();

  $('a[href*="#"]:not([href="#"]):not(.testimony-control):not(.carousel-control)').click(function () {
...
Webflow.require("ix").init([
      ...
      triggers: [
        {
          ...
          stepsA: [{ title: "Show Search", height: "auto", transition: "height 250ms ease-in 0" }],
          stepsB: [{ title: "Hide Search", height: "0px", transition: "height 250ms ease-out 0" }],
        },
      ],
    },
  },
  {
    slug: "progress-bar",
    name: "Progress Bar",
    value: { style: { width: "0px" }, triggers: [{ type: "scroll", stepsA: [{ wait: "1000ms" }, { width: "47%", transition: "width 750ms ease-out 0" }], stepsB: [] }] },
  },
]);
...
(function () {
  ...
  $(".facebook-share, .twitter-share").click(function (e) {
    ...
    window.open(
      $(this).attr("href"),
      "fbShareWindow",
      "height=290, width=600, top=" + ($(window).height() / 2 - 145) + ", left=" + ($(window).width() / 2 - 300) + ", toolbar=0, location=0, menubar=0, directories=0, scrollbars=0"
    );
    return false;
  });

  //DONATION AUTO SELECT
  ...
  //check right radio
  if (params.amount) {
    //If amount matches radio then check, otherwise add to other amount field
    if ($("#donation_amount_" + params.amount).length) {
      $("#donation_amount_" + params.amount).prop("checked", true);
    } else {
      $("#donation_amount_other").val(params.amount);
    }

    //trigger next
    $(document).ready(function () {
      $(".progress-stage-button-next.first").trigger("click");
    });
  }
})();
