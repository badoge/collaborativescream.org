...
Webflow.require('ix').init([
  {"slug":"search-panel","name":"Search Panel","value":{"style":{},"triggers":[{"type":"click","selector":".search-panel","stepsA":[{"title":"Show Search","height":"auto","transition":"height 250ms ease-in 0"}],"stepsB":[{"title":"Hide Search","height":"0px","transition":"height 250ms ease-out 0"}]}]}},
  {"slug":"progress-bar","name":"Progress Bar","value":{"style":{"width":"0px"},"triggers":[{"type":"scroll","stepsA":[{"wait":"1000ms"},{"width":"47%","transition":"width 750ms ease-out 0"}],"stepsB":[]}]}}
]);
...
(function () {
  ...
  $('.facebook-share, .twitter-share').click(function(e) {
      e.preventDefault();
      window.open($(this).attr('href'), 'fbShareWindow', 'height=290, width=600, top=' + ($(window).height() / 2 - 145) + ', left=' + ($(window).width() / 2 - 300) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0');
      return false;
  });
